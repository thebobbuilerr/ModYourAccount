...
// #[starknet::interface]
// pub trait ISwapping<TState> {
//     fn swap(self: @TState, amount: felt252);
// }
...
mod DefiWallet {
    ...
    use mod_your_wallet::component::AccountComponent;
    use mod_your_wallet::component::AccountComponent::InternalTrait as AccountInternalTrait;
    use mod_your_wallet::component::ValidatorComponent;
    use mod_your_wallet::component::{IValidator, ICoreValidator, IValidator_ID, IConfigure};
    use mod_your_wallet::component::IVersion;
    ...
    // #[abi(embed_v0)]
    // pub impl Swapping of ISwapping<ContractState> {
    //     fn swap(self: @ContractState, amount: felt252) {
    //         let caller = get_caller_address();
    //         let self = get_contract_address();
    //         assert(self == caller, Errors::UNAUTHORIZED);
    //         self.account.notify_owner_addition(array![amount]);
    //     }
    // }
